...
function Footer() {
  return (
    <footer className='w-full flex flex-col items-start bg-[#FCFCFC] dark:bg-[#100108] lg:py-[0] py-[1.5rem] px-[1rem] md:px-[2rem] lg:px-[0]'>
        <div className=' w-full flex flex-col lg:flex-row items-start self-stretch gap-[2.375rem] lg:justify-between lg:items-center lg:gap-0 lg:py-10 lg:px-14 py-[2.5rem] '>
            ...
            <nav className='flex flex-col items-start gap-[0.8125rem]'>
            ...
            <div className='flex flex-col items-start gap-3'> 
                <h3 className='font-inter lg:text-base text-xs lg:font-[700] font-[600] self-stretch text-[#9D979A]'>QUICK LINKS</h3>
                <div className='flex flex-col items-start lg:gap-2 gap-6 self-stretch'>
                    <a href=""className='flex lg:justify-start justify-center items-center lg:self-stretch lg:gap-2 lg:py-4 ' >
                ...
                <a href=""className='flex justify-center items-center lg:self-stretch lg:gap-2 lg:py-4' >
                        <span className="font-inter lg:text-base text-xs lg:font-[400] font-[600] text-[#100108] dark:text-[#FCFCFC]">
                            Download Resume
                        </span>
                  <MdArrowOutward className="h-5 w-5 text-[#100108] dark:text-[#FCFCFC]" />
